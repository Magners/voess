...
import com.kdfje.inc.repository.FriendshipRepository;
...
import static com.kdfje.inc.web.rest.TestUtil.sameInstant;
...
public class FriendshipResourceIntTest {
    ...
    public void createFriendship() throws Exception {
        ...
        assertThat(testFriendship.getFinshDateTime()).isEqualTo(DEFAULT_FINSH_DATE_TIME);
    }
    ...
    public void updateFriendship() throws Exception {
        ...
        assertThat(testFriendship.getFinshDateTime()).isEqualTo(UPDATED_FINSH_DATE_TIME);
    }
