(function() {
    ...
    PlayerDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Player', 'Country', 'Video'];

    function PlayerDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Player, Country, Video) {
        var vm = this;
