...
import com.kdfje.inc.repository.TeamFormerRepository;
...
public class TeamFormerResource {
    ...
    @Timed
    public List<TeamFormer> getAllTeamFormers() {
        log.debug("REST request to get all TeamFormers");
        List<TeamFormer> teamFormers = teamFormerRepository.findAll();
        return teamFormers;
    }
